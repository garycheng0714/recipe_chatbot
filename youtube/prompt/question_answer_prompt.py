...
class QuestionAnswerPrompt(BasePrompt):

    def render(self, content: str | dict) -> str:
        return f"""
# Role
...
# Task
Your task is to analyze a comprehensive "Cleaned Text" of a podcast interview chapter. 
...
[
  {{
    ...
    "answer": "Improvement goes hand-in-hand with dedication. Runners need to learn the 'why' behind training zones, particularly the importance of zone 2 training.",
    "topic": "training"
  }},
  {{
    "question": "How should amateur runners structure their weekly training schedules?",
    "answer": "Look at the whole week as a macro-cycle and log your runs Monday through Sunday instead of winging it.",
    "topic": "training"
  }},
  {{
    "question": "What role do sleep and recovery play in a runner's improvement plan?",
    "answer": "Sleep and recovery are just as critical as running; if you sleep only 5 hours, no training plan will save you.",
    "topic": "recovery"
  }}
]
...
[
  {{
    ...
    "answer": "Recreational runners should prioritize Zone 2 training to build a solid aerobic base before adding high-intensity workouts.",
    "topic": "training"
  }},
  {{
    "question": "What is the recommended nutrition strategy for runners during long distance runs?",
    "answer": "Fueling during long runs is non-negotiable; athletes should aim to consume 60 to 90 grams of carbohydrates per hour to avoid hitting the wall.",
    "topic": "nutrition"
  }}
]
