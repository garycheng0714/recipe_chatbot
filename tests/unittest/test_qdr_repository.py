...
async def test_find_all_points_single_page():
    ...
    result = await repository.find_all_points(collection_name="test_col", batch_size=2)
...
async def test_find_all_points_multiple_pages():
    ...
    # 2. 呼叫目標函式
    result = await repository.find_all_points(collection_name="test_col", batch_size=1)
...
async def test_find_all_points_empty():
    ...
    result = await repository.find_all_points(collection_name="empty_col")
