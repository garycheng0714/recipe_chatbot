...
def test_full_recall():
    ...
    assert RecallCalculator.calculate(relevant, results) == 1.0
...
def test_partial_recall():
    ...
    assert RecallCalculator.calculate(relevant, results) == 0.5
...
def test_zero_hits():
    ...
    relevant = ["doc1", "doc2"]
    results = ["doc3", "doc4"]
    assert RecallCalculator.calculate(relevant, results) == 0.0
